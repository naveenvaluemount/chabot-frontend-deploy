...
export class FuseNavigationService
{
     ...
     */
        ...
        //         compact: [{
        //             icon: 'heroicons_outline:char-pie',
        //             id: 'example',
        //             link: '/example',
        //             title: 'Example',
        //             type: 'basic'
        ...
        //         ]
        //     };
        //     return this.httpClient.get<Navigation>(environment.apiURL + environment.apiEndPoints.menuByRoleId).pipe(
        //         tap((navigation: any) => {
        //             if(navigation?.response?.setPassword) {
        ...
        //     // return this._navigation.next(menu);
        //     // return this._navigation.next(menu);
